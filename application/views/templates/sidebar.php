                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="dashboard">
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        <a href="<?= base_url() ?>demo3/index.html">
                                            <span class="sub-item">Dashboard 3</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url() ?>demo4/index.html">
                                            <span class="sub-item">Dashboard 4</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url() ?>demo5/index.html">
                                            <span class="sub-item">Dashboard 5</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url() ?>demo6/index.html">
                                            <span class="sub-item">Dashboard 6</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url() ?>demo7/index.html">
                                            <span class="sub-item">Dashboard 7</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url() ?>demo8/index.html">
                                            <span class="sub-item">Dashboard 8</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url() ?>demo9/index.html">
